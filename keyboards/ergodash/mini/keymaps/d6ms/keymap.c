...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  |Delete|                    | Enter|   N  |   M  |   -  |  =   |   ,  |   .  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * | Ctrl |  GUI |  ALt | EISU |||||||| Lower|Delete| Bksp |||||| |Space | Enter| Lower|||||||| Raise| Alt  |  /   | Ctrl |
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_DEL ,                        KC_ENT , KC_N,    KC_M,    KC_MINS, KC_EQL,  KC_COMM, KC_DOT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_DEL , KC_BSPC,       KC_SPC, KC_ENT , LOWER,            RAISE,   KC_RALT, KC_SLSH,   KC_RCTL  \
  ),
  ...
  /* Raise
  * ,----------------------------------------------------------------------------------------------------------------------.
  * |   `  |  F1  |  Up  |  F3  |  F4  |  F5  |   _  |                    |   +  |  F6  |  F7  |  F8  |  F9  | F10  |  |   |
  * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
  * |   ~  | Left | Down |Right |   F4 |   F5 |   {  |                    |   }  | Left | Down |  Up  | Right|   :  |  "   |
  * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
  ...
  */
  [_RAISE] = LAYOUT(
    KC_GRV , KC_F1,   KC_UP,   KC_F3,   KC_F4,   KC_F5,   KC_UNDS,                        KC_PLUS, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_PIPE, \
    KC_TILD, KC_LEFT, KC_DOWN, KC_RGHT, KC_F4,   KC_F5,   KC_LCBR,                        KC_RCBR, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT, KC_COLN, KC_DQT , \
